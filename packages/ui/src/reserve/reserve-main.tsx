				...
				items={[
					{
						...
						value: unixSecToMonthYearTime(
							dateToUnixSec(new Date(startDate as unknown as number)),
						),
					},
					{
						field: 'End Date',
						value: unixSecToMonthYearTime(
							dateToUnixSec(new Date(endDate as unknown as number)),
						),
					},
					{
						field: 'Base Price',
						value: formatPrice(basePrice as unknown as number),
					},
				]}
			/>
			<PaymentButton
