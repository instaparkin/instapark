...
const PrivacyPolicyPage = () => {
	return (
		<Page title="Privacy Policy">
			...
			<ul>
				...
				<li>
					<p>
						...
						this Agreement) refers to Instapark .
					</p>
				</li>
				<li>
					<p>
				...
				<li>
					<p>
						...
						identified or identifiable inPageidual.
					</p>
				</li>
				<li>
					<p>
				...
				<li>
					<p>
						...
						third-party companies or inPageiduals employed by the Company to
				...
				<li>
					<p>
						<strong>Website</strong> refers to Instapark , accessible from{' '}
						<a
							href="http://www.instapark.in"
							rel="external nofollow noopener"
							target="_blank"
						>
							http://www.instapark.in
						</a>
					</p>
				</li>
				<li>
					<p>
						<strong>You</strong> means the inPageidual accessing or using the
						Service, or the company, or other legal entity on behalf of which
						such inPageidual is accessing or using the Service, as applicable.
					</p>
				</li>
			</ul>
			...
			<ul>
				...
				<li>
					<p>
						...
						to evaluate or conduct a merger, Pageestiture, restructuring,
			...
			<ul>
				<li>By email: instapark.founder@gmail.com</li>
			</ul>
		</Page>
	);
};
