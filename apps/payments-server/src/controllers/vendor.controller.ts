...
export const createVendor = (req: SessionRequest, res: Response) => {
    try {
        ...
        const options = {
            method: 'POST',
            headers: {
                'x-api-version': PAYMENTS_SERVER_CONSTANTS.CASHFREE_API_VERSION,
                'x-client-id': PAYMENTS_SERVER_CONSTANTS.CASHFREE_CLIENT_ID,
                'x-client-secret': PAYMENTS_SERVER_CONSTANTS.CASHFREE_CLIENT_SECRET,
